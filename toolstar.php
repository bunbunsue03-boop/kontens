...
echo "<p><b>Mode Kompresi:</b> <span style='color:blue;font-weight:bold;'>Format Kontainer .tar (Terpisah: AMP & Asli)</span></p>";
...
if ($isProcessed) {
    ...
    $tarNameAmp  = 'amp-kct' . $host . '.tar';
    $tarNameAsli = 'template' . $host . '.tar';
